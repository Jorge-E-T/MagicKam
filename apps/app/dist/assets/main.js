...
window._presetStorage = new PresetStorage();})();
const presetStorage = window._presetStorage;
(function() {
...
function getLastLoadFailures() { return [..._lastLoadFailures]; }

function getCustomPresetSources() {
  try {
...
function saveCustomPresetSources(sources) {
  try {
...
function getDefaultPresetEnabled() {
  try {
...
function saveDefaultPresetEnabled(enabled) {
  try {
...
function earnCredit(importedPresetName) {
...
function unlockPresetWithCredit(presetName) {
  const state = loadUnlockState();
...
function refundCredit(presetName) {
  const state = loadUnlockState();
...
function unlockAllPresets(allAvailablePresets) {
  const state = loadUnlockState();
...
const _presetImporter = new PresetImporter();window._presetImporter = _presetImporter;
window._earnCredit = earnCredit;
window._unlockAllPresets = unlockAllPresets;
window._getCredits = getCredits;
window._presetsAreDifferent = presetsAreDifferent;
window._getCustomPresetSources = getCustomPresetSources;
window._saveCustomPresetSources = saveCustomPresetSources;
window._getDefaultPresetEnabled = getDefaultPresetEnabled;
window._saveDefaultPresetEnabled = saveDefaultPresetEnabled;
})();
const presetImporter = window._presetImporter;
const earnCredit = window._earnCredit;
const unlockAllPresets = window._unlockAllPresets;
const getCredits = window._getCredits;
const presetsAreDifferent = window._presetsAreDifferent;
const getCustomPresetSources = window._getCustomPresetSources;
const saveCustomPresetSources = window._saveCustomPresetSources;
const getDefaultPresetEnabled = window._getDefaultPresetEnabled;
const saveDefaultPresetEnabled = window._saveDefaultPresetEnabled;
